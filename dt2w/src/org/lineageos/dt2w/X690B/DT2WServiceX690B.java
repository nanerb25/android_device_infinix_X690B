...
public class DT2WServiceX690B extends Service {
    private static final String TAG = "DT2WServiceX690B";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.X690B.dt2w", dt2wEnabled ? "1" : "0");
        }
