package org.lineageos.dt2w.X657C;
...
public class DT2WServiceX657C extends Service {
    private static final String TAG = "DT2WServiceX657C";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.X657C.dt2w", dt2wEnabled ? "1" : "0");
        }
